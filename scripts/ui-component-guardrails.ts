export const uiComponentGuardrails = {
  internalImports: {
    ...
    'relative:src/lib/components/ui/button/button.svelte': 16,
    ...
    'relative:src/lib/components/ui/toggle-group/index.ts': 1,
    'relative:src/lib/components/ui/tooltip/Tooltip.svelte': 2,
    'relative:src/lib/components/ui/tooltip/index.ts': 2,
  },
  rawControls: { button: 625, input: 84, select: 0, textarea: 11 },
} as const;
